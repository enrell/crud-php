...
class Description {
    ...
    private function validate(string $value): void {
        ...
        if (strlen($trimmedValue) < self::MIN_LENGTH) {
            throw new InvalidArgumentException("Description must be at least " . self::MIN_LENGTH . " characters long.");
        }
        ...
        if (preg_match('/^[\s\W]*$/', $trimmedValue)) {
            throw new InvalidArgumentException("Description must contain meaningful content.");
        }
    }
