...
if ($_POST) {
        ...
        if ($action === 'create') {
            ...
            if ($result) {
                ...
                $_SESSION['error_message'] = 'Failed to delete patient. They may have active appointments.';
            }
        }
    }
    ...
    <main class="container">
        ...
        <div class="table-container">
            <div class="table-header">
                <h3>All Patients</h3>
                <div class="table-stats"><?= count($patients) ?> total patients</div>
            </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($patients as $patient): ?>
                            <tr>
                                ...
                                <td style="padding-right: 145px;"><?= htmlspecialchars($patient['birthdate']) ?></td>
                                <td style="padding-right: 80px;"><?= htmlspecialchars($patient['blood_type']) ?></td>
                                <td class="actions">
                                    <button class="btn btn-warning" onclick="openEditModal(<?= $patient['id'] ?>, '<?= htmlspecialchars($patient['name']) ?>', '<?= $patient['birthdate'] ?>', '<?= htmlspecialchars($patient['blood_type']) ?>')">Edit</button>
