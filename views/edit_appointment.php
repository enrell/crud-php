...
if ($_POST && $appointment) {
    ...
    $result = $appointmentRepository->update($appointment['id'], $doctorId, $patientId, $appointmentDate, $description);
    if ($result) {
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="3" required 
                              placeholder="Describe the reason for the appointment..."><?= htmlspecialchars($appointment['description']) ?></textarea>
                </div>
